...
export default function Todo() {
  ...
  const handleAddTask = async (newTask: NewTask) => {
    try {
      ...
      toast.custom(() => <SuccessToast message='Task added successfully' />)
    } catch (error) {
  ...
  const toggleTaskCompletion = async (taskId: string) => {
    ...
    try {
      ...
      toast.custom(() => <SuccessToast message='Task updated successfully' />)
    } catch (error) {
  ...
  const handleDeleteTask = async (id: string) => {
    try {
      ...
      // Show success message
      toast.custom(() => <SuccessToast message='Task deleted successfully!' />)
    } catch (error) {
    ...
    <div className='flex flex-col h-full'>
      ...
      {state.isLoading ? (
        ...
        <div className='flex flex-col items-center justify-center flex-1'>
          ...
          <p className='text-muted-foreground'>Try adding your first task using the button above</p>
        </div>
